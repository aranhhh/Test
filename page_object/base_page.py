...
class BasePage(object):
    ...
    def screenshot(self, info='-', class_name='', testcase_name=''):
        """
        截图,起名为：文件名-方法名-注释
        :param info: 截图说明
        :param class_name 类名
        ...
        filepath = catalog_name + class_name + "@" + testcase_name + info + ".png"
        self.driver.get_screenshot_as_file(filepath)
        log.info(u'截图：%s.png' % info)

    def screenshot_by_locator(self, locator, info='-', class_name='', testcase_name=''):
        a = self.driver.find_element_by_xpath('//*[@id="su"]')
        a.screenshot(r'E:\项目组\a.png')
    def screenshot_by_element(self, element, info='-', class_name='', testcase_name=''):
        pass
